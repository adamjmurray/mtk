...
describe MTK::Patterns::EventChain do
  ...
  describe "#next" do
    ...
    it "defaults to duration 1 when no durations are given" do
      event_builder =  EVENT_CHAIN.new [Patterns.NoteSequence(C4, D4, E4), Patterns.IntensityCycle(p,f)]
    ...
    it "iterates through the pitch, intensity, and duration list in parallel to emit Notes" do
      event_builder = EVENT_CHAIN.new [Patterns.PitchCycle(C4, D4, E4), Patterns.IntensityCycle(p, f), Patterns.DurationCycle(1,2,3,4)]
      event_builder.next.should == [Note(C4, p, 1)]
      event_builder.next.should == [Note(D4, f, 2)]
    ...
    it "returns nil (for a rest) when it encounters a nil value" do
      event_builder = EVENT_CHAIN.new [Patterns.PitchCycle(C4, D4, E4, F4, nil), Patterns.IntensityCycle(mp, mf, f, nil), Patterns.DurationCycle(1, 2, nil)]
    ...
    it "uses the default_pitch when no pitch pattern is provided" do
      event_builder = EVENT_CHAIN.new [Patterns.IntensityCycle( mp, mf, f )], :default_pitch => G3
