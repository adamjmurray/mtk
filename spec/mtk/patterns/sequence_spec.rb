...
describe MTK::Patterns do
  ...
  describe "#PitchSequence" do
    ...
    it "sets #elements from the varargs" do
      MTK::Patterns.PitchSequence(1,2,3).elements.should == [1,2,3]
    end
  ...
  describe "#IntensitySequence" do
    ...
    it "sets #elements from the varargs" do
      MTK::Patterns.IntensitySequence(1,2,3).elements.should == [1,2,3]
    end
  ...
  describe "#DurationSequence" do
    ...
    it "sets #elements from the varargs" do
      MTK::Patterns.DurationSequence(1,2,3).elements.should == [1,2,3]
    end
