module MTK
  module Sequencers
    ...
    class Sequencer
      ...
      # @option options [Class] :event_builder replace the {Patterns::EventChain} with a custom Event pattern
      def initialize(patterns, options={})
        ...
        event_builder_class = options.fetch :event_builder, Patterns::EventChain
