module MTK
  ...
  # Construct a {PitchClassList}
  # @see #PitchClassList
  def PitchClassList(*anything)
    PitchClassList.new(Helper::Convert.to_pitch_classes *anything)
  end
  module_function :PitchClassList
